...
import { Trash2, RefreshCw, User, Mail, Calendar, Activity, ChevronDown, RotateCcw, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, MoreHorizontal, Clock, Search, X, Filter } from 'lucide-react'
                        ...
                        {loading ? (
                            ...
                            <Table
                                columns={[
                                    ...
                                    { label: 'Latest Performance', style: { width: '18%' } },
                            ...
                            >
                                {filteredUsers.slice((currentPage - 1) * entriesPerPage, currentPage * entriesPerPage).map((user, index) => (
                                    <CTableRow key={user._id}>
                                        ...
                                        <CTableDataCell className="text-end pe-4" style={{ width: '100px' }}>
